<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车票名称" prop="chepiaomingcheng">
          <el-input v-model="ruleForm.chepiaomingcheng" 
              placeholder="车票名称" clearable  :readonly="ro.chepiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车票名称" prop="chepiaomingcheng">
              <el-input v-model="ruleForm.chepiaomingcheng" 
                placeholder="车票名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上车地点" prop="shangchedidian">
          <el-input v-model="ruleForm.shangchedidian" 
              placeholder="上车地点" clearable  :readonly="ro.shangchedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上车地点" prop="shangchedidian">
              <el-input v-model="ruleForm.shangchedidian" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出发时间" prop="chufashijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chufashijian" label="出发时间" prop="chufashijian">
              <el-input v-model="ruleForm.chufashijian" 
                placeholder="出发时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="预计到达时间" prop="yujidaodashijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.yujidaodashijian" 
                type="datetime"
                placeholder="预计到达时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yujidaodashijian" label="预计到达时间" prop="yujidaodashijian">
              <el-input v-model="ruleForm.yujidaodashijian" 
                placeholder="预计到达时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="途径地" prop="tujingdi">
          <el-input v-model="ruleForm.tujingdi" 
              placeholder="途径地" clearable  :readonly="ro.tujingdi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="途径地" prop="tujingdi">
              <el-input v-model="ruleForm.tujingdi" 
                placeholder="途径地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	chepiaomingcheng : false,
	shangchedidian : false,
	mudedi : false,
	chufashijian : false,
	yujidaodashijian : false,
	tujingdi : false,
	jiage : false,
	renshu : false,
	xiangxixinxi : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chepiaomingcheng'){
            this.ruleForm.chepiaomingcheng = obj[o];
	    this.ro.chepiaomingcheng = true;
            continue;
          }
          if(o=='shangchedidian'){
            this.ruleForm.shangchedidian = obj[o];
	    this.ro.shangchedidian = true;
            continue;
          }
          if(o=='mudedi'){
	    ...
	    this.ro.chufashijian = true;
          ...
          if(o=='yujidaodashijian'){
            this.ruleForm.yujidaodashijian = obj[o];
	    this.ro.yujidaodashijian = true;
            continue;
          }
          if(o=='tujingdi'){
	...
	this.ruleForm.xiangxixinxi = this.ruleForm.xiangxixinxi.replace(reg,'../../../springboot0t1t7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qichepiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qichepiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
