<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="换票目的地" prop="huanpiaomudedi">
          <el-input v-model="ruleForm.huanpiaomudedi" 
              placeholder="换票目的地" clearable  :readonly="ro.huanpiaomudedi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="换票目的地" prop="huanpiaomudedi">
              <el-input v-model="ruleForm.huanpiaomudedi" 
                placeholder="换票目的地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          huanpiaomudedi: [
                { required: true, message: '换票目的地不能为空', trigger: 'blur' },
          ],
          sfsh: [
          ],
          shhf: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shoujihao = true;
          ...
          if(o=='huanpiaomudedi'){
            this.ruleForm.huanpiaomudedi = obj[o];
	    this.ro.huanpiaomudedi = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huanpiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huanpiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
